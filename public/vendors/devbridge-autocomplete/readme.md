...
* `onSelect`: `function (suggestion) {}` Callback function invoked when clinicUser selects suggestion
...
* `tabDisabled`: Default `false`. Set to true to leave the cursor in the input field after the clinicUser tabs to select a suggestion.
